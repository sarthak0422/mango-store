...
//Above is the code for production and below is for portfolio

// D:\Portfoltio_Projects\mango-store\src\services\payment.js
import { httpsCallable } from "firebase/functions";
import { functions } from "../firebase/config"; // 👈 Import your configured instance
...
export const initializeRazorpayPayment = async ({
  ...
  try {
    // 1. Create order from the automatically configured server instance
    const createOrderCloudTrigger = httpsCallable(functions, "createRazorpayOrder"); // 👈 Changed here
